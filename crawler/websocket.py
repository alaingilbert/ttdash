...
def create_connection(hostname='localhost', port=8000, resource='/', is_secure=False, timeout=None, **options):
    """
    ...
    websock.connect(hostname, port, resource, is_secure, **options)
    return websock
...
class WebSocket(object):
    ...
    def connect(self, hostname='localhost', port=8000, resource='/', is_secure=False, **options):
        """
        Connect to url. url is websocket url scheme. ie. ws://host:port/resource
        """
        #hostname, port, resource, is_secure = _parse_url(url)
        #hostname, port, resource, is_secure = ('chat.turntable.fm', 6501, '/socket.io/websocket', False)
